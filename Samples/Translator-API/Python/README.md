# Azure Translator API (Public Preview)

![Azure Translator API](/Images/thumbnail-translator-API.png)

The Azure Translator API (Public Preview) enables you to translate text leveraging neural machine translation (NMT) or large language model translation (LLM). In this episode, April shows you how to translate a conversation between an English speaking customer support agent and a French speaking customer, accommodating for both tone and gender.

Try it yourself in Microsoft Foundry and start translating with LLMs: [ai.azure.com](https://ai.azure.com)

## Prerequisites

- A Microsoft Foundry resource created in the [Azure portal](https://portal.azure.com). Review the [Azure Resources for Translator](https://aka.ms/insideAIF/configure-Azure-resources) document for guidance.
